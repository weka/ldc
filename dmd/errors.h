...
inline D_ATTRIBUTE_FORMAT(2, 3) void error(const Loc& loc, const char *format, ...) {}
inline D_ATTRIBUTE_FORMAT(4, 5) void error(const char *filename, unsigned linnum, unsigned charnum, const char *format, ...) {}
