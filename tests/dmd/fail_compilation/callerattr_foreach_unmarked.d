...
struct CtxContainer
{
    ...
    { foreach (x; data) if (auto r = @CTX_SWITCH dg(x)) return r; return 0; }
}
...
TEST_OUTPUT:
---
fail_compilation/callerattr_foreach_unmarked.d(22): Error: call to `@CTX_SWITCH` function `callerattr_foreach_unmarked.yieldNow` must be marked `@CTX_SWITCH yieldNow()`
