...
// RUN:   && %ldc %s -c -of=%t%obj -cache=%T/flag1cache -O5                              -vv | FileCheck --check-prefix=NO_HIT %s \
...
// RUN:   && %ldc %s -c -of=%t%obj -cache=%T/flag1cache                                  -vv | FileCheck --check-prefix=MUST_HIT %s
